...
const SideFilters = () => {
  return (
    <div className='hidden xl:block w-[331px] h-[400px]'>

       <hr className='border-2 border-black/5 w-[66%] my-2 ml-[52px]' />

<div className='w-full h-[1040px] pl-[71px] pr-2 overflow-y-scroll my-scrolling-area'>
       <h2 className='font-bold mt-4 mb-3 tracking-wide'>PRICE</h2>
       <div className=' flex h-[170px] my-scrolling-area overflow-y-scroll flex-col gap-2'>
        <span className='text-[12px] flex items-center gap-3'>
         <input type='radio' className='w-3 h-3 rounded-full' />
          Below ₹ 10,001 
          <span className='text-[12px] text-green-700'>(2)</span>
        </span>
         ...
         <input type='radio' className='w-3 h-3 rounded-full' />
            ₹ 10,001 - ₹ 15,000 
          <span className='text-[12px] text-green-700'>(22)</span>
        </span>

         <span className='text-[14px] flex items-center gap-3'>
         <input type='radio' className='w-3 h-3 rounded-full' />
          ₹ 10,001 - ₹ 15,000 
          <span className='text-[12px] text-green-700'>(83)</span>
        </span>

         <span className='text-[14px] flex items-center gap-3'>
         <input type='radio' className='w-3 h-3 rounded-full' />
          ₹ 10,001 - ₹ 15,000 
          <span className='text-[12px] text-green-700'>(89)</span>
        </span>

         <span className='text-[14px] flex items-center gap-3'>
         <input type='radio' className='w-3 h-3 rounded-full' />
          ₹ 10,001 - ₹ 15,000 
          <span className='text-[12px] text-green-700'>(100)</span>
        </span>
         ...
         <input type='radio' className='w-3 h-3 rounded-full' />
          ...
          <span className='text-[12px] text-green-700'>(100)</span>
              ...
              <hr className='border-2 border-black/5 w-[80%] my-4' />
                ...
                <div className=' flex tracking-wider  flex-col gap-1'>
                  ...
                  <hr className='border-2 border-black/5 w-[80%] my-4' />
                      ...
                      <h2 className='font-bold mb-3 tracking-wide'>METAL COLOUR</h2>
                <div className=' flex tracking-wider flex-col gap-1'>
                      <div className='text-[14px] flex gap-2 items-center'>
                          <span className='pt-1'><input type='radio' checked readOnly className='w-3 h-3 rounded-full' /> 💍</span>
            ...
            <hr className='border-2 border-black/5 w-[80%] my-4' />
               ...
               <button className='radialBg ml-[52px] text-white mt-7 w-[279px] h-[49px] rounded-[10px]'>More Filters</button>
    </div>
  )
}
